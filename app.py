...
leitor_pdf_sicoob_text = [
    'SICOOBSISTEMA DE COOPERATIVAS'
]
...
def upload_pdfs():
    ...
    for arquivo in arquivos:
        ...
        # Banco Sicoob -> 
        for texto_padrao in leitor_pdf_sicoob_text:
            if texto_padrao in texto:

                lista_dados =  sicoob.lendo_pdf_sicoob_CODIGO_IA(arquivo.filename)
...
#     app.run(host='0.0.0.0', port=4224, debug=True)
